...
1. You suspect there are inter dependencies between X=sow weight, Y=food eaten and Z=hormones in food
2. You suspect there are inter dependencies between X=distance ran, Y=speed per km and Z=water drunk.
3. You suspect there are inter dependencies between X=rain, Y=pressure and Z=latitude coordinates
