{
  ...
  outputs = { self, nixpkgs, flake-utils }:
   ...
   propagatedBuildInputs = with pkgs.rPackages; [caret mlbench dplyr ggplot2 knitr devtools shiny reticulate Metrics ppcor glue lubridate tsibble ggfortify gridExtra jsonlite tidyverse fpp3 readr imputeTS reshape2];
      };
    in {
